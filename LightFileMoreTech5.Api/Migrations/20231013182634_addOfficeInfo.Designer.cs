...
namespace LightFireMoreTech5.Migrations
{
    ...
    [Migration("20231013182634_addOfficeInfo")]
    partial class addOfficeInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LightFireMoreTech5.Data.Entities.Office", b =>
                {
                    ...
                    b.Property<long>("ShceduleId")
                        .HasColumnType("bigint")
                        .HasColumnName("shceduleid");
                    ...
                    b.HasIndex("ShceduleId")
                        .HasDatabaseName("ix_offices_shceduleid");
            ...
            modelBuilder.Entity("LightFireMoreTech5.Data.Entities.Office", b =>
                {
                    b.HasOne("LightFireMoreTech5.Data.Entities.OfficeSchedule", "Schedule")
                        .WithMany("Offices")
                        .HasForeignKey("ShceduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_offices_officeschedules_scheduleid");
