...
namespace LightFireMoreTech5.Migrations
{
    ...
    [Migration("20231014144039_fixForignKeys")]
    partial class fixForignKeys
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LightFireMoreTech5.Data.Entities.Window", b =>
                {
                    ...
                    b.HasIndex("officeId")
                        .HasDatabaseName("ix_window_officeid1");
            ...
            modelBuilder.Entity("LightFireMoreTech5.Data.Entities.WindowService", b =>
                {
                    ...
                    b.HasIndex("WindowId")
                        .HasDatabaseName("ix_window_service_windowid");

                    b.HasIndex("serviceId")
                        .HasDatabaseName("ix_window_service_serviceid");

                    b.ToTable("window_service", null, t =>
                        {
                            t.Property("WindowId")
                                .HasColumnName("windowid1");
                        });
                });
            ...
            modelBuilder.Entity("LightFireMoreTech5.Data.Entities.Window", b =>
                {
                    ...
                    b.HasOne("LightFireMoreTech5.Data.Entities.Office", "Office")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_window_offices_officeid1");
            ...
            modelBuilder.Entity("LightFireMoreTech5.Data.Entities.WindowService", b =>
                {
                    ...
                    b.HasOne("LightFireMoreTech5.Data.Entities.Window", "Window")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_window_service_window_windowid1");
